    ...
    <div className="min-h-screen bg-gradient-to-b from-yellow-50 to-purple-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-3xl mx-auto bg-white/80 backdrop-blur-sm p-8 rounded-lg border border-yellow-200">
          <h1 className="text-3xl font-bold mb-6 text-purple-800">About Email Header Analyzer</h1>
          ...
          <div className="prose prose-purple max-w-none">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 my-8">
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-semibold text-purple-700">Header Analysis</h3>
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-semibold text-purple-700">Security Verification</h3>
                <p className="text-sm text-gray-600">
              ...
              <div className="flex flex-col items-center text-center">
                ...
                <h3 className="font-semibold text-purple-700">Threat Detection</h3>
                <p className="text-sm text-gray-600">
